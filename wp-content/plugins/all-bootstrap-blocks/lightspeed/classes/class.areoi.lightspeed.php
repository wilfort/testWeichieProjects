...
class AREOI_Lightspeed
{
	...
	private static function init_hooks() 
	{
		...
		if ( get_option( 'areoi-lightspeed-features-include-block-patterns', false ) ) {
	...
	public static function register_blocks()
	{
		...
		if ( is_admin() ) {
			...
			wp_localize_script( 'areoi-lightspeed-blocks', 'areoi_lightspeed_vars', array(
				...
				'is_icons' 		=> get_option( 'areoi-dashboard-global-bootstrap-icon-css', false )
			) );
	...
	public static function add_scripts() 
	{
		...
		$gallery = get_option( 'areoi-lightspeed-features-include-gallery', false );
		if ( $gallery ) {
	...
	{
		$is_lazy = get_option( 'areoi-lightspeed-performance-lazy-load', false );
	...
	{
		$is_webp = get_option( 'areoi-lightspeed-performance-webp', false );
