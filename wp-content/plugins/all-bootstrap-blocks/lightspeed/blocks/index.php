...
function lightspeed_get_placeholder_images( $key = null )
{
	...
	$images = array(
		array(
			...
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . 'assets/placeholders/' . $directory . '/image-1.webp',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 750,
		...
		array(
			...
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . 'assets/placeholders/' . $directory . '/image-2.webp',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 750,
		...
		array(
			...
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . 'assets/placeholders/' . $directory . '/image-3.webp',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 750,
		...
		array(
			'id' => 4,
			'title' => 'image-4',
			'filename' => 'image-4.webp',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . 'assets/placeholders/' . $directory . '/image-4.webp',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 750,
