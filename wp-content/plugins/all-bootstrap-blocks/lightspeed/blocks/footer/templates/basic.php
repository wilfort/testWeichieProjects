			...
			<div class="row row-cols-1 row-cols-md-2 align-items-center justify-content-center justify-content-md-between small">
				<div class="col text-center text-md-start">
					<p class="mb-2 mb-md-0">
						<?php _e( 'Copyright ' ) ?>&copy; <?php echo date( 'Y' ) ?> <?php echo get_option( 'areoi-lightspeed-company-name', get_bloginfo( 'name' ) ) ?>

						<?php if ( get_option( 'areoi-lightspeed-company-number', null ) ) : ?>
							<br>Company No. <?php echo get_option( 'areoi-lightspeed-company-number', null ) ?>
						<?php endif; ?>

						<?php if ( get_option( 'areoi-lightspeed-company-vat-number', null ) ) : ?>
							<br>VAT No. <?php echo get_option( 'areoi-lightspeed-company-vat-number', null ) ?>
						<?php endif; ?>
					</p>
				</div>
