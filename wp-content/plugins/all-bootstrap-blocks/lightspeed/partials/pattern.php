...
$bottom = '0px';
if ( get_option( 'areoi-lightspeed-styles-strip-background', null ) ) $bottom = '-125px';
if ( ( get_option( 'areoi-lightspeed-parallax-parallax', null ) && get_option( 'areoi-lightspeed-parallax-patterns', null ) ) || get_option( 'areoi-lightspeed-transition-background', null ) ) $bottom = '125px';
if ( get_option( 'areoi-lightspeed-parallax-parallax', null ) && get_option( 'areoi-lightspeed-parallax-patterns', null ) && !get_option( 'areoi-lightspeed-styles-strip-background', null ) ) $bottom = '370px';
?>
